...
import static com.airliftcasestudy.base.util.K.RetrofitConstants.RETROFIT_METHOD_GET;
import static com.airliftcasestudy.base.util.K.RetrofitConstants.RETROFIT_METHOD_POST;
...
public class LoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        String requestLog = String.format(
                InjectUtils.INSTANCE.getResource().getString(R.string.retrofit_logging_request),
                request.url(),
                chain.connection(),
                request.headers(),
                request.method() +
                        InjectUtils.INSTANCE.getResource().getString(R.string.retrofit_request_method_type));
        ...
        String responseLog = String.format(Locale.US,
                InjectUtils.INSTANCE.getResource().getString(R.string.retrofit_logging_response),
